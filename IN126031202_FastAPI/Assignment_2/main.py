...
# ── Pydantic Models (Class code done in class) ────────────────
...
# ── Helper Functions (from class code) ───────────────────────
...
# ── Endpoint 2 — Filter products (Day2 updated filter) ────────
...
# ----- EndPoint 3/Q2 -- Filters Products by Category -----
...
# Deal and Premium pick endpoint
...
# Place order (Class code endpoint)
@app.post('/orders')
