...
class CheckoutRequest(BaseModel):                       # Day 5
...
# Fixed routes (/filter /compare /audit /discount /cart/add /cart/checkout)
# BEFORE variable routes (/{product_id} /cart/{product_id})
#
# ══════════════════════════════════════════════════════════════════
